...
module.exports = {
  router: function(req,res){
    ...
    if(req.method == "GET"){
      if(isPositiveInteger(args[0]) && (args[1] == "edit")) return helm_helpers.updateView(helm, req,res);
      ...
      if(isPositiveInteger(args[0]) && args[1] == "delete") return helm_helpers.deletePost(helm, req,res);
      else if(isPositiveInteger(args[0]) && (args[1] == "edit")) return helm_helpers.updatePost(helm, req,res);
